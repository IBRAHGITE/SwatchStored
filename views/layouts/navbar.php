          ...
          <div class="col-lg-6">
            <div class="d-flex align-items-center">
              <div class="top-bar-item me-4">
                ...
                <span>Contact à Abidjan: </span>
                <a href="tel:+1234567890">+225 0777661815</a>
              </div>
            ...
            <div class="d-flex justify-content-end">
              <div class="top-bar-item me-4">
                <a href="track-order.html">
                  <i class="bi bi-truck me-2"></i>Livraison en gros et détails
                </a>
              </div>
      ...
      <div class="container-fluid container-xl">
        <div class="d-flex py-3 align-items-center justify-content-between">
          ...
          <a href="index.html" class="logo d-flex align-items-center">
            ...
            <h1 class="sitename">Smart Watch<span> Store</span></h1>
          </a>
    ...
    <div class="header-nav">
      <div class="container-fluid container-xl position-relative">
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="./?page=home&var=index">Nos Produis</a></li>
