            ...
            <div class="product-gallery">
              ...
              <div class="thumbnails-vertical">
                <div class="thumbnails-container">
                  <div class="thumbnail-item active" data-image="assets/img/product/product-details-1.webp">
              ...
              <div class="main-image-wrapper">
                <div class="image-zoom-container">
                  <a href="assets/img/product/product-details-1.webp" class="glightbox" data-gallery="product-gallery">
          ...
          <div class="container">
            <div class="sticky-content">
              <div class="product-preview">
                <img src="assets/img/product/product-details-1.webp" alt="Product" class="product-thumbnail">
          ...
          <div class="col-12">
            <div class="product-details-accordion">
                      ...
                      <div class="row mt-4">
                        <div class="col-md-6">
                          ...
                          <ul class="feature-list">
                            ...
                            <li><i class="bi bi-check-circle"></i> Vestibulum at lacus congue, suscipit elit nec, tincidunt orci</li>
                            <li><i class="bi bi-check-circle"></i> Phasellus egestas nisi vitae lectus imperdiet venenatis</li>
                            <li><i class="bi bi-check-circle"></i> Suspendisse vulputate quam diam, et consectetur augue</li>
                            <li><i class="bi bi-check-circle"></i> Aenean dapibus urna eget nisi pharetra, in iaculis nulla</li>
                          </ul>
                        </div>
                        <div class="col-md-6">
              ...
              <div class="accordion-item" id="reviews">
                <h2 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#reviewsContent" aria-expanded="false" aria-controls="reviewsContent">
                    Customer Reviews (42)
                  </button>
                </h2>
                    ...
                    <div class="product-reviews">
                      ...
                      <div class="review-form-container mt-5">
                        ...
                        <form class="review-form">
                          ...
                          <div class="sent-message">Your review has been submitted. Thank you!</div>
